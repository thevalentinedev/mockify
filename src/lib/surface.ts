...
export const glass = "soft-glass";
export const chrome = "soft-chrome";
export const glassBottom = "soft-glass-bottom";
export const glassScrim = "soft-glass-scrim";
export const glassSheet = "soft-glass-sheet";
